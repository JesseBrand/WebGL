...
DotSphere = function( color, x, z, val, valcolor, render, html_label, titles, minScaleVal, scaleDif, valHeight ) {

  console.log("DotSphere - x: " + x + " z: " + z + " val: " + val)
  ...
  this.addBar = function( target ){
    ...
    var geometry = new THREE.SphereGeometry( this.sqsize, 10, 10 );
